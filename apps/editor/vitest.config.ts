...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@gamekit/runtime/rigid-body": path.resolve(
        __dirname,
        "../../packages/runtime/src/rigid-body.ts"
      ),
      ...
      "@gamekit/runtime/gestures": path.resolve(
        __dirname,
        "../../packages/runtime/src/gestures.ts"
      ),
      ...
      "@gamekit/runtime/simulate": path.resolve(
        __dirname,
        "../../packages/runtime/src/simulate.ts"
      ),
