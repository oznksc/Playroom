...
export function PanelHeader({
  ...
  return (
    <div
      className={cn(
        "flex h-[38px] shrink-0 items-center justify-between gap-2 border-b border-border-default bg-bg-base px-2.5",
        className
      )}
      {...props}
    >
...
export function PanelSectionTitle({
  ...
  return (
    <div
      className={cn(
        "mb-1.5 mt-2 flex items-center gap-1.5 px-1 text-xs font-semibold uppercase tracking-[0.08em] text-text-muted select-none first:mt-0",
        className
      )}
      {...props}
    >
